...
// Tapdance CAPSLOCK: Send KC_CAPSLOCK after 3 taps
enum {
    TD_TRIPLE_CAPS,
};
void dance_capslock(tap_dance_state_t *state, void *user_data) {
    if (state->count >= 3) {
        tap_code16(KC_CAPS);
    }
}
tap_dance_action_t tap_dance_actions[] = {
    [TD_TRIPLE_CAPS] = ACTION_TAP_DANCE_FN(dance_capslock),
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(/* 0: qwerty */
                     LT(1, KC_GRV), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC,
                     KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS,
                     LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
                     KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_DEL,
                     KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, LT(2, KC_SPC), LT(2, KC_SPC), KC_RALT, TD(TD_TRIPLE_CAPS), KC_LEFT, KC_DOWN, KC_RIGHT),
    [1] = LAYOUT_all(/* 1: fn */
